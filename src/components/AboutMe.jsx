    ...
    return (
        <div className="about-container">
            ...
            <div className="about-text-container">
                <p>¡Hola! Mi nombre es <span>Tommy</span> y construyo páginas web. Soy un Desarrollador Front-End autodidacta iniciado en 2022.</p>
                <p>Disfruto llevar a cabo la maquetación e interactividad de interfaces web, así como la optimización.</p>
                <p>Mi <span>objetivo</span> ha sido el mismo desde un principio: obtener la atención del usuario, más allá de un buen diseño, con una interfaz útil e interactiva.</p>
            </div>
